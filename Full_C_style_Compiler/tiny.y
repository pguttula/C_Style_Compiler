...
stat:
   ...
   |
   TOKEN_PRINTLN TOKEN_LPAREN paramsln TOKEN_RPAREN TOKEN_SCOLON {$$ = 
  ...
  /* TOKEN_IF expr stat {$$ = mk_if_node(NODE_IF,$2,$3); }
   ...
   |
   TOKEN_INPUT TOKEN_LPAREN idlist TOKEN_RPAREN TOKEN_SCOLON {$$ = 
                                         mk_input_node(NODE_INPUT,$3);
   }
;
...
paramsln:
    param {$$ = mk_param_node(NODE_PARAMLN,$1,NULL);}
    |
    param TOKEN_COMMA paramsln {$$ = mk_param_node(NODE_PARAMLN,$1,$3);
    }
;
param:
    expr {$$ = $1; }
